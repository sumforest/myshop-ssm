        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form:form action="/user/save" id="inputForm" cssClass="form-horizontal" method="post" modelAttribute="tbUser">
                        <form:hidden path="id"/>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <form:input path="phone" cssClass="form-control required mobile" placeholder="请输入用户手机号码"/>
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
