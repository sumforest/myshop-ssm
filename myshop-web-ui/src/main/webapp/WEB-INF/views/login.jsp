            ...
            <div class="kengl_kuang">
                <form action="/login" method="post">
                    ...
                    <div class="txt_kuang">
                        ...
                        <input style="width: 140px; height: 25px;" id="validation" name="validation" type="text" class="itxt"  placeholder="验证码">
                        <img id="validationCode" style="height: 25px;float: right; padding-right: 36px;width: 93px;cursor: pointer;" src="/verification" title="看不清？换一张">
                    </div>
                    <div class="remember">
                        <div class="fl">
                            <input type="checkbox" >
...
<script>
    $(function () {
        // 刷新验证码
        $("#validationCode").bind("click", function () {
